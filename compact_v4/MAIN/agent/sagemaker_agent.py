...
AGENT_TYPES = {
    ...
    "verify": {
        ...
        "prompt_suffix": (
            ...
            "   - CLI/scripts: run with representative inputs, test edge inputs (empty, malformed, boundary)\n"
            ...
            "6. Run adversarial probes: boundary values (0, -1, empty, None, MAX_INT), "
            "idempotency, orphan operations, error recovery.\n\n"
