...
def _new_child_engine(parent_engine: Any, max_turns: int, agent_type: str = "general", model_id: str = "") -> Any:
    ...
    return QueryEngine(
        ...
        status_callback=getattr(parent_engine, "status_callback", None),
        tool_gen_callback=getattr(parent_engine, "tool_gen_callback", None),
        abort_events=getattr(parent_engine, "abort_events", ()),
    )
