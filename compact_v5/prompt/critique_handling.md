...
If the source isn't accessible, say so and reason about the pasted text — flag the limitation. Never fabricate file references.
...
- `PARTIAL` — partial agreement. State which holds, which doesn't.
