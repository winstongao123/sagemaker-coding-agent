...
| R14 | READY_WITH_PROCESS_FOLLOWUP | AWS artifact pass, Phase C GENUINE_PASS, gate pass, committed/pushed; process follow-up open for repeated tool failures | Multi-file refactor proof | Pytest green + grep clean |
| R15 | READY | AWS pass, Phase C GENUINE_PASS, gate pass, committed/pushed | Debugging proof | Both bugs fixed, no false positives |
| R16 | EXECUTABLE_PENDING_REVIEW | Zero-cost spec exists; needs Phase A review/execution | Long-session app-build proof | App/tests pass, compaction reviewed |
...
| R18-E7 | EXECUTABLE_PENDING_REVIEW | Zero-cost edge spec exists; needs Phase A review/execution | Long output truncation proof | Truncation visible, agent continues |
...
| R19-U3 | EXECUTABLE_PENDING_REVIEW | Zero-cost UX spec exists; needs Phase A review/execution | Hidden dependency refactor proof | Search before edit; tests pass |
| R19-U4 | EXECUTABLE_PENDING_REVIEW | Zero-cost UX spec exists; needs Phase A review/execution | Conflicting sub-agent reconciliation | Evidence-based parent decision |
| R19-U5 | EXECUTABLE_PENDING_REVIEW | Zero-cost UX spec exists; needs Phase A review/execution | Sub-agent failure recovery | Parent completes after child failure |
| R19-U6 | EXECUTABLE_PENDING_REVIEW | Zero-cost UX spec exists; needs Phase A review/execution | Garbage tool output recovery | Retry/alternative path succeeds |
| R19-U7 | EXECUTABLE_PENDING_REVIEW | Zero-cost UX spec exists; needs Phase A review/execution | Repeated-call circuit breaker proof | Third repeat blocked, alternative used |
