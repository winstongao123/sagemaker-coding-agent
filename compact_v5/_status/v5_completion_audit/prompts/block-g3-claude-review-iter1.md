...
- `compact_v5/_status/v5_completion_audit/blocks/G3/STATUS.md`
- `compact_v5/_status/v5_completion_audit/blocks/G3/BASELINE.md`
- `compact_v5/_status/v5_completion_audit/blocks/G3/LEDGER.md`
- `compact_v5/_status/v5_completion_audit/blocks/G3/TESTS.md`
- `compact_v5/_status/v5_completion_audit/blocks/G3/CHANGELOG.md`
- `compact_v5/_status/v5_completion_audit/blocks/G3/DECISIONS.md`
- `compact_v5/_status/v5_completion_audit/blocks/G3/WORKER_SELF_REVIEW.md`
- `compact_v5/_status/v5_completion_audit/blocks/G3/GIT_CLOSE_PLAN.md`
- `compact_v5/_status/V5_RUNNABLE_PORT_LOG.md` rows #092 and #093
- `compact_v5/_status/V5_DESIGN_DECISIONS.md` ADR-032
...
- G3-1 is implemented by the coordinator system prompt plus default-off config and QueryEngine wiring.
- G3-2 is implemented by coordinator user context plus QueryEngine first-user-message injection for parent coordinator mode.
- Focused G3 tests passed with `15 passed, 1 skipped`.
- `py_compile` passed for coordinator, QueryEngine, and config files.
- `scope_audit.py --block G3` reported `READY_TO_REVIEW_CLOSE` with 0 ship-blocking rows.
- No AWS/R-tier spend was run or approved.
- The real Haiku orchestration test remains skipped under the no-AWS rule; evaluate whether the local deterministic tests and documented R-tier gate are sufficient for block close.

Required output:

Return text only to stdout. Include `REVIEWED ROWS` with `G3-1` and `G3-2` exactly once each, plus `VERDICT:` and `SHIP DECISION:`.
