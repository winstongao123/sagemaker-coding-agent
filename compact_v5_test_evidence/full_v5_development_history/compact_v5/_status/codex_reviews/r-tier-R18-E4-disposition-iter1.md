# R-tier R18-E4 Reviewed Disposition
...
Disposition rationale: Skill activation is canonical-name based in v5. The new local lock proves frontmatter aliases do not create an activation alias surface and canonical resolution still works.
